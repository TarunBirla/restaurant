...
<section style="position:relative; background:#0D0D0D; color:#fff; overflow:hidden;">
    ...
    <div style="position:absolute; inset:0; background:linear-gradient(90deg,rgba(13,13,13,0.9) 0%,rgba(13,13,13,0.35) 100%); display:flex; align-items:center;">
        <div style="max-width:1280px; margin:0 auto; padding:0 24px; width:100%;">
            <div style="max-width:600px;">

                <div style="display:inline-flex; align-items:center; gap:8px; background:rgba(232,55,14,0.18); border:1px solid rgba(232,55,14,0.4); padding:7px 16px; border-radius:999px; margin-bottom:22px;">
                    <i data-lucide="zap" style="width:14px; height:14px; color:#E8370E; flex-shrink:0;"></i>
                    <span style="font-size:12px; font-weight:600; color:#E8370E; font-family:'Poppins',sans-serif; letter-spacing:.04em;">Fast Delivery In 30 Min</span>
                </div>

                <h1 class="hero-title" style="font-family:'Poppins',sans-serif; font-size:48px; font-weight:800; line-height:1.15; margin:0 0 18px; letter-spacing:-.5px;">
                    Delicious Food<br><span style="color:#E8370E;">Delivered</span> To<br>Your Door
                </h1>

                <p style="font-size:16px; color:#D1D5DB; line-height:1.8; margin:0 0 32px; max-width:460px; font-weight:400;">
                ...
                <div class="hero-cta" style="display:flex; gap:12px; flex-wrap:wrap;">
                    <a href="#products" class="btn-primary" style="padding:14px 28px; font-size:15px; display:flex; align-items:center; gap:8px; text-decoration:none; letter-spacing:.02em;">
                        <i data-lucide="shopping-bag" style="width:17px; height:17px;"></i> Order Now
                    </a>
                    <a href="#categories" style="padding:14px 28px; font-size:15px; font-family:'Poppins',sans-serif; font-weight:600; border:2px solid rgba(255,255,255,0.25); border-radius:12px; color:#fff; text-decoration:none; display:flex; align-items:center; gap:8px; transition:border-color .18s; letter-spacing:.02em;"
...
<section style="padding:80px 0; background:linear-gradient(135deg,#FFF7F4,#FFFFFF);">
    <div style="max-width:1280px; margin:auto; padding:0 24px;">
        <div class="qr-wrapper" style="display:grid; grid-template-columns:1.2fr 0.8fr; gap:56px; align-items:center;">
            ...
            <!-- LEFT -->
            <div>
                <span style="background:#FFE7E0; color:#E8370E; padding:7px 18px; border-radius:50px; font-size:12px; font-weight:700; display:inline-block; margin-bottom:18px; font-family:'Poppins',sans-serif; letter-spacing:.04em;">
                    Scan & Order
                </span>
                <h2 class="qr-title section-title" style="font-size:38px; line-height:1.2; font-weight:800; margin-bottom:18px; font-family:'Poppins',sans-serif; color:#111827; letter-spacing:-.5px;">
                ...
                <div style="display:flex; gap:20px; flex-wrap:wrap;">
                    <div style="display:flex; align-items:center; gap:12px;">
                        <div style="width:46px; height:46px; background:#E8370E; border-radius:12px; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                    ...
                    <div style="display:flex; align-items:center; gap:12px;">
                        <div style="width:46px; height:46px; background:#111827; border-radius:12px; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
            ...
            <div style="display:flex; justify-content:center;">
                <div style="background:#fff; padding:36px; border-radius:28px; box-shadow:0 20px 60px rgba(0,0,0,.09); text-align:center; border:1px solid #F1F1F1; max-width:340px; width:100%;">
                    <div style="width:88px; height:88px; background:#FFF2EE; border-radius:22px; margin:0 auto 22px; display:flex; align-items:center; justify-content:center;">
                        <i data-lucide="qr-code" style="width:42px; height:42px; color:#E8370E;"></i>
                    </div>
                    <h3 style="font-size:24px; font-weight:800; margin-bottom:8px; font-family:'Poppins',sans-serif; color:#0D0D0D;">Scan Me</h3>
                    <p style="color:#6B7280; font-size:14px; margin-bottom:24px;">Open restaurant menu instantly</p>
                    <div style="background:#FAFAF8; padding:18px; border-radius:18px; display:inline-block; border:1px solid #F0F0EC;">
                        {!! $qrCode !!}
                    </div>
                </div>
            </div>
...
<section id="categories" style="max-width:1280px; margin:0 auto; padding:80px 24px;">
    <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:36px; flex-wrap:wrap; gap:12px;">
        <div>
            <p style="color:#E8370E; font-family:'Poppins',sans-serif; font-weight:700; font-size:12px; letter-spacing:.1em; text-transform:uppercase; margin:0 0 6px;">Browse</p>
            <h2 class="section-title" style="font-family:'Poppins',sans-serif; font-size:36px; font-weight:800; margin:0; letter-spacing:-.4px;">Food Categories</h2>
        </div>
    ...
    <div class="categories-grid" style="display:grid; grid-template-columns:repeat(5,1fr); gap:16px;">
        ...
        <a href="/category/{{ $category->id }}"
           ...
           onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 12px rgba(0,0,0,.06)'; this.style.borderColor='#F0F0EC';">
            <h3 style="font-family:'Poppins',sans-serif; font-weight:700; font-size:15px; margin:0; color:#0D0D0D; text-align:center;">
                {{ $category->name }}
            </h3>
        </a>
        @endforeach
...
<section id="products" style="background:#fff; padding:80px 0;">
    <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
        <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:36px; flex-wrap:wrap; gap:12px;">
            <div>
                <p style="color:#E8370E; font-family:'Poppins',sans-serif; font-weight:700; font-size:12px; letter-spacing:.1em; text-transform:uppercase; margin:0 0 6px;">Today's Pick</p>
                <h2 class="section-title" style="font-family:'Poppins',sans-serif; font-size:36px; font-weight:800; margin:0; letter-spacing:-.4px;">Featured Products</h2>
            </div>
            ...
            <div style="background:#fff; border-radius:20px; overflow:hidden; box-shadow:0 2px 16px rgba(0,0,0,.07); border:1px solid #F0F0EC; transition:all .22s;"
                ...
                <div style="padding:18px;">
                    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:8px; gap:8px;">
                        <h3 style="font-family:'Poppins',sans-serif; font-weight:700; font-size:16px; margin:0; line-height:1.35; color:#0D0D0D;">
                            {{ $product->name }}
                        </h3>
...
<section style="background:#0D0D0D; padding:80px 0; color:#fff;">
    <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
        <div class="offer-grid" style="display:grid; grid-template-columns:1fr 1fr; gap:60px; align-items:center;">
            ...
            <div>
                <div style="display:inline-flex; align-items:center; gap:8px; background:rgba(232,55,14,0.15); border:1px solid rgba(232,55,14,0.3); padding:7px 16px; border-radius:999px; margin-bottom:22px;">
                    <i data-lucide="tag" style="width:14px; height:14px; color:#E8370E;"></i>
                    <span style="font-size:12px; font-weight:700; color:#E8370E; font-family:'Poppins',sans-serif; letter-spacing:.05em;">Limited Time Offer</span>
                </div>
                <h2 class="offer-title" style="font-family:'Poppins',sans-serif; font-size:48px; font-weight:800; line-height:1.2; margin:0 0 18px; letter-spacing:-.5px;">
                ...
                <a href="#products" class="btn-primary" style="padding:14px 30px; font-size:15px; display:inline-flex; align-items:center; gap:9px; text-decoration:none;">
            ...
            <div class="offer-img" style="position:relative;">
                ...
                <div style="position:absolute; top:-16px; right:-16px; width:76px; height:76px; border-radius:50%; background:#E8370E; display:flex; flex-direction:column; align-items:center; justify-content:center; font-family:'Poppins',sans-serif; font-weight:800; color:#fff; font-size:14px; line-height:1.2; text-align:center; box-shadow:0 8px 24px rgba(232,55,14,.5);">
...
<section style="max-width:1280px; margin:0 auto; padding:80px 24px;">
    <div style="text-align:center; margin-bottom:52px;">
        <p style="color:#E8370E; font-family:'Poppins',sans-serif; font-weight:700; font-size:12px; letter-spacing:.1em; text-transform:uppercase; margin:0 0 8px;">Our Promise</p>
        <h2 class="section-title" style="font-family:'Poppins',sans-serif; font-size:36px; font-weight:800; margin:0 0 10px; letter-spacing:-.4px;">Why Choose Us</h2>
    ...
    <div class="features-grid" style="display:grid; grid-template-columns:repeat(4,1fr); gap:20px;">
        ...
        <div class="card" style="padding:30px 22px; text-align:center; transition:transform .22s; border:1px solid #F0F0EC;"
             onmouseover="this.style.transform='translateY(-4px)'" onmouseout="this.style.transform='translateY(0)'">
            <div style="width:58px; height:58px; background:{{ $f['color'] }}18; border-radius:16px; display:flex; align-items:center; justify-content:center; margin:0 auto 18px;">
                <i data-lucide="{{ $f['icon'] }}" style="width:26px; height:26px; color:{{ $f['color'] }};"></i>
            </div>
            <h3 style="font-family:'Poppins',sans-serif; font-size:17px; font-weight:700; margin:0 0 10px; color:#0D0D0D;">{{ $f['title'] }}</h3>
