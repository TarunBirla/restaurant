    ...
    <div style="max-width:1280px; margin:0 auto; padding:60px 24px 36px;">
            ...
            <div>
                ...
                <div style="display:flex; gap:10px;">
                    <a href="#" style="width:38px; height:38px; border:1px solid #2A2A2A; border-radius:10px; display:flex; align-items:center; justify-content:center; transition:all .18s; flex-shrink:0;"
                       onmouseover="this.style.borderColor='#C25A2A'; this.style.background='rgba(232,55,14,.1)'"
        ...
        <div style="border-top:1px solid #1F1F1F; padding-top:28px;">
            <div class="footer-bottom" style="display:flex; justify-content:space-between; align-items:center;">
                ...
                <p style="color:#4B5563; font-size:13px; margin:0;">Made with <span style="color:#C25A2A;">♥</span> for food lovers</p>
            </div>
        </div>
