        ...
        <div class="footer-grid" style="display:grid; grid-template-columns:2fr 1fr 1fr 1fr; gap:48px; margin-bottom:48px;">
            ...
            <div>
                ...
                <div style="display:flex; gap:10px;">
                    <a href="#" style="width:38px; height:38px; border:1px solid #2A2A2A; border-radius:10px; display:flex; align-items:center; justify-content:center; transition:all .18s; flex-shrink:0;"
                       onmouseover="this.style.borderColor='#E8370E'; this.style.background='rgba(232,55,14,.1)'"
            ...
            <div>
                ...
                <ul style="list-style:none; padding:0; display:flex; flex-direction:column; gap:12px;">
                    <li><a href="/" style="color:#9CA3AF; text-decoration:none; font-size:14px; transition:color .15s; display:flex; align-items:center; gap:6px;"
                           onmouseover="this.style.color='#E8370E'" onmouseout="this.style.color='#9CA3AF'">
                        <i data-lucide="chevron-right" style="width:13px; height:13px;"></i> Home
                    </a></li>
                    <li><a href="#categories" style="color:#9CA3AF; text-decoration:none; font-size:14px; transition:color .15s; display:flex; align-items:center; gap:6px;"
                           onmouseover="this.style.color='#E8370E'" onmouseout="this.style.color='#9CA3AF'">
                        <i data-lucide="chevron-right" style="width:13px; height:13px;"></i> Categories
                    </a></li>
            ...
            <div>
                ...
                <ul style="list-style:none; padding:0; display:flex; flex-direction:column; gap:14px;">
                    <li style="display:flex; align-items:flex-start; gap:10px; color:#9CA3AF; font-size:14px; line-height:1.5;">
                        <i data-lucide="map-pin" style="width:15px; height:15px; color:#E8370E; flex-shrink:0; margin-top:2px;"></i>
                        123 Food Street, City
                    </li>
                    <li style="display:flex; align-items:center; gap:10px; color:#9CA3AF; font-size:14px;">
                        <i data-lucide="phone" style="width:15px; height:15px; color:#E8370E; flex-shrink:0;"></i>
                        +1 234 567 890
                    </li>
                    <li style="display:flex; align-items:center; gap:10px; color:#9CA3AF; font-size:14px;">
