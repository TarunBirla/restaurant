...
@section('content')
    ...
    <section
        style="background:linear-gradient(135deg,#0D0D0D 0%,#1a1a1a 100%); padding:48px 0; border-bottom:3px solid #E8370E;">
        <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
            <div style="display:flex; align-items:center; gap:20px; flex-wrap:wrap;">
                <div
                    style="width:72px; height:72px; background:#E8370E; border-radius:18px; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                    <i data-lucide="utensils" style="width:32px; height:32px; color:#fff;"></i>
                </div>
                <div>
                    <p
                        style="color:#E8370E; font-family:'Poppins',sans-serif; font-weight:700; font-size:11px; letter-spacing:.12em; text-transform:uppercase; margin:0 0 4px;">
                        Restaurant</p>
                    <h1
                        style="font-family:'Poppins',sans-serif; font-size:32px; font-weight:800; color:#fff; margin:0; letter-spacing:-.4px;">
                        {{ $restaurant->name }}
                    </h1>
    ...
    <section style="background:#F5F5F0; padding:40px 0 80px;">
        <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
            ...
            <div
                style="display:flex; gap:10px; overflow-x:auto; margin-bottom:40px; padding-bottom:4px; scrollbar-width:none;">
                <style>
            ...
            <!-- SECTION LABEL -->
            <div
                style="display:flex; justify-content:space-between; align-items:center; margin-bottom:28px; flex-wrap:wrap; gap:10px;">
                <div>
                    <p
                        style="color:#E8370E; font-family:'Poppins',sans-serif; font-weight:700; font-size:11px; letter-spacing:.1em; text-transform:uppercase; margin:0 0 5px;">
                        Today's Pick</p>
                    <h2
                        style="font-family:'Poppins',sans-serif; font-size:28px; font-weight:800; margin:0; letter-spacing:-.3px; color:#0D0D0D;">
            ...
            <div class="res-products-grid" style="display:grid; grid-template-columns:repeat(4,1fr); gap:22px;">
                    ...
                    <div style="background:#fff; border-radius:20px; overflow:hidden; box-shadow:0 2px 16px rgba(0,0,0,.07); border:1px solid #F0F0EC; transition:all .22s;"
                        ...
                        <div style="position:relative; overflow:hidden;">
                            ...
                            <div
                                ...
                                <span
                                    style="font-family:'Poppins',sans-serif; font-size:13px; font-weight:800; color:#E8370E;">£{{ $product->price }}</span>
                            </div>
                        </div>

                        <div style="padding:18px;">
                            <h3
                                style="font-family:'Poppins',sans-serif; font-weight:700; font-size:16px; margin:0 0 8px; line-height:1.35; color:#0D0D0D;">
                                {{ $product->name }}
                            </h3>
                            ...
                            <div style="display:flex; gap:8px;">
                                <a href="javascript:void(0)" class="btn-black"
                                    ...
                                    style="flex:1; text-align:center; padding:10px 0; font-size:13px; text-decoration:none;">3D
                                    View</a>
                ...
                @empty
                    <div
                        ...
                        <h3
                            style="font-family:'Poppins',sans-serif; font-size:22px; font-weight:700; margin-bottom:10px; color:#0D0D0D;">
                            No Products Found</h3>
                        <p style="color:#6B7280; font-size:14px; margin:0 0 24px;">This category has no products available right
                            now.</p>
    ...
    <div class="ar-modal" id="arModal">
        ...
        <div class="ar-overlay">
            ...
            <p class="drag-text">Drag to rotate</p>
    ...
    <script>
        ...
        async function openAR(image) {

            document.getElementById("arModal").style.display = "block";

            pizza.style.backgroundImage = `url('${image}')`;
            ...
            try {
                ...
                alert("Camera permission allow kare");
        ...
        pizza.addEventListener("touchstart", function (e) {
        ...
        pizza.addEventListener("touchend", function () {

            isDragging = false;

        });

        pizza.addEventListener("touchmove", function (e) {
